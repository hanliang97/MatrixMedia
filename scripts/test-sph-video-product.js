...
assert.strictEqual(normalizeVideoProductId(" 10000591263144 "), "10000591263144");
...
assert.strictEqual(buildVideoProductOption("抖音", "10000591263144").value.enabled, false);
...
assert.strictEqual(
  getVideoLinkTypeCapability("视频号", "member_zone"),
  null
);
assert.deepStrictEqual(
  buildVideoLinkOption(
